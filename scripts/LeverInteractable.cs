...
public class LeverInteractable : MonoBehaviour, IInteractable
{
    ...
    void Start()
    {
        ...
        if (triggerCollider == null)
            Debug.LogError($"{gameObject.name}: LeverInteractable requer um Collider2D com isTrigger = true");
    }
    ...
    private void ActivateLever()
    {
        ...
        InteractionHistory.RecordInteraction(gameObject, activateTrigger);
    }
